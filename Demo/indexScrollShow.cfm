...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style type="text/css">
			body { max-width: auto; overflow-x: hidden;  position: relative; } #map { height:550px; width:100%; } #map2 { height:300px; width:450px; } .search-results { list-style-type:none !important; }
